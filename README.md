...
# DQN Agent Unity Collect Bananas Environment


### Introduction

For this project, I used a Deep Q-network agent to navigate (and collect bananas!) in a large, square world.  
...
2. Place the downloaded file in the folder where you clone this repository, and unzip (or decompress) the file. 
